...
> 锁定职缺:**AI 业务流程优化负责人 / AI Workflow Lead**
> 一句话:把体育运营团队「每天人工拼日报」这件重复工作,拆成 SOP → 规则引擎 + Claude 自动化 → 可复用模板库,一条端到端工作流覆盖取数、异动监控、风控预警、日报撰写、自动推送。

打开 [`AI工作流_Demo報告.html`](AI工作流_Demo報告.html) 看全貌(面试官视角的落地报告)。
